...
protoc --proto_path=${ROOT}/examples/helloworld  --go-test_out=mod=github.com/1477921168/ego/examples/helloworld,out=./server,paths=source_relative:. helloworld.proto
